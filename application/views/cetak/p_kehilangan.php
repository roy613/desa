        ...
        <table border=0 style="margin-top:15px; width:100%; font-size:12pt">
            <tr>
                <td style="text-align:center">
                    <h4><b><u>SURAT PENGANTAR KEHILANGAN</u></b></h4>
                </td>
            </tr>
            <tr>
                <td style="text-align:center">
        ...
        <table border=0 style="margin-top:0px; margin-left:15px; width:100%; font-size:12pt">
            <tr>
                <td style="text-align: justify;">
                    Adalah benar nama tersebut di atas telah kehilangan <?php echo $k->s_7; ?> pada tanggal <?php echo tgl_indo($k->sd_2); ?> berdasarkan laporan yang
                    bersangkutan sehingga diperlukan Surat Keterangan Kehilangan untuk membuat dokumen baru.
                </td>
            </tr>
            <tr>
                <td style="text-align: justify;">
                    Demikian Surat Keterangan Kehilangan ini diberikan untuk selanjutnya dapat dibuatkan Surat
                    Keterangan Kehilangan dari POLSUBSEKTOR Kecamatan Karangan.
