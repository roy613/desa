        ...
        <table border=0 style="margin-top:15px; width:100%; font-size:12pt">
            <tr>
                <td style="text-align:center">
                    <h4><b><u>SURAT KETERANGAN USAHA</u></b></h4>
                </td>
            </tr>
            <tr>
                <td style="text-align:center">
        ...
        <table border=0 style="margin-top:0px; margin-left:15px; width:100%; font-size:12pt; padding:2px">
            <tr>
                <td style="text-align: justify;">
                    Adalah benar nama tersebut mempunyai Usaha sebagaimana yang dimaksud diatas yang terletak di
                    <?php echo $k->s_6; ?> RT. <?php echo $k->s_7; ?> Desa Karangan Hilir Kecamatan Karangan Kabupaten Kutai Timur.
                </td>
            </tr>
            <tr>
                <td style="text-align: justify;">
