        ...
        <table border=0 style="margin-top:0px; margin-left:90px; width:100%; font-size:12pt">
            <tr>
                <td style="text-align: justify;">
                    Dengan ini kami selaku Pemerintah Desa Karangan Hilir memohon kepada Camat Karangan agar dapat memberikan Rekomendasi Kerja kepada nama yang bersangkutan di atas sebagai kelengkapan berkas untuk melamar kerja agar dapat diterima pada Perusahaan <?php echo Ucwords($k->s_8); ?>.
                </td>
            </tr>
            <tr>
                <td style="text-align: justify;">
