    ...
    <font face="arial">
        ...
        <table border=0 style="margin-top:0px; width:100%; margin-left:0px; font-size:12pt">
            ...
            <tr>
                ...
                <td>
                <?php echo Ucwords($k->n_tptlahir_21); ?>, <?php echo tgl_indo($k->n_tgllahir_21); ?>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                <?php echo ucwords($k->n_alamat_21); ?>
                </td>
            </tr>
            <tr>
                <td colspan="5">
            ...
            <tr>
                ...
                <td>
                <?php echo Ucwords($k->n_tptlahir_22); ?>, <?php echo tgl_indo($k->n_tgllahir_22); ?>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                <?php echo ucwords($k->n_alamat_22); ?>
                </td>
            </tr>
        </table>
