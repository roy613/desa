        ...
        <font face="arial">
            ...
            <table border=0 style="width: 100%; font-size:12pt; margin-top:-10px">
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td style="text-align:center"> <u><b><?php echo ucwords($k->n_nama_2); ?></b></u></td>
                </tr>
            </table>
            <table border=0 style="width: 100%; font-size:12pt; margin-top:-10px">
                <tr>
