        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <a data-toggle="modal" data-target="#m_surat" class="btn btn-sm btn-outline-primary" style="float:right" onclick="empty1()">Catat Surat</a>
              <h5 style="color: dimgrey;">
                PENCATATAN SURAT MANUAL
              </h5>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo ucwords($p->s_jabatan); ?>-<?php echo ucwords($p->s_ttd); ?></td>
                            ...
                            <table border="0">
                              <tr>
                                ...
                                <td>
                                  ...
                                  '<?php echo $p->s_1; ?>',                             
                                  '<?php echo $p->s_nosurat; ?>',                             
                                  '<?php echo $p->s_jenispelayanan; ?>',                             
      ...
      <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header bg-dark">
            <h5 class="modal-title" id="exampleModalLabel">Catat Surat</h5>
          ...
          <div class="modal-body">
            ...
            <form method="post" action="<?php echo base_url('be/simpan_be/catat_surat') ?>" enctype="multipart/form-data">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="csurat_nama">Nama Penerima</label>
                      <input type="text" class="form-control" id="csurat_nama" name="csurat_nama" placeholder="Input Nama Penerima .." required>
                      <input type="hidden" name="id" id="id" class="form-control">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="csurat_no">Nomor Surat</label>
                      <input type="text" class="form-control" id="csurat_no" name="csurat_no" placeholder="Input No Surat .." required>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="csurat_jenis">Jenis Surat</label>
                      <input type="text" class="form-control" id="csurat_jenis" name="csurat_jenis" placeholder="Input Jenis Surat .." required>
                    </div>
                  </div>
                  <div class="col-md-5">
                    <div class="form-group">
    ...
    <div class="modal fade" id="arsip" tabindex="-3" aria-labelledby="exampleModalLabel" a data-backdrop="static" data-keyboard="false" aria-hidden="true">
      <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="<?php echo base_url() . 'be/simpan_be/arsip_csurat' ?>" enctype="multipart/form-data">
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
