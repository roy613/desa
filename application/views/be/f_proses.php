<script>
    ...
    function berkas_selesai(a) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.open("https://kirimwa.id/petok/"+a+":(uji_coba)Surat_anda_sudah_selesai_dan_bisa_diambil_di_Kantor_Camat!_pesan_ini_dikirim_secara_otomatis_dengan_menggunakan_petokapps._Anda_tidak_perlu_membalasnya._Terima_kasih!!!", '_blank');
