                        ...
                        <tr>
                          ...
                          <td style="text-align: center; width:10%">
                            <table border="0">
                              <tr>
                                <td>
                                  <a target="_blank" class="btn btn-outline-success" href="<?php echo base_url('cetak_ket_domisili/' . base64_encode($p->s_id)) ?>" style="font-size: 10pt !important; padding:4px !important" title="Cetak"><i class="fa fa-print"></i></a>
                                </td>
                                <td>
                                  <a href="#" onclick="edit(
                                  '<?php echo $p->s_id; ?>',
      ...
      <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form method="post" action="<?php echo base_url('be/simpan_be/domisili') ?>" enctype="multipart/form-data">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="hilang_nama">Nama Lengkap</label>
                      <input type="text" class="form-control" id="domisili_nama" name="domisili_nama" placeholder="Input Nama Pemohon .." required>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="domisili_tptlahir" name="domisili_tptlahir" placeholder="Input Tempat Lahir Pemohon .." required>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="domisili_kewarganegaraan" name="domisili_kewarganegaraan" placeholder="Input Kewarganegaraan Pemohon .." required>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="domisili_agama">Agama</label>
                      <select class="form-control" id="domisili_agama" name="domisili_agama" placeholder="Input Agama Pemohon .." required>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="number" onkeyup="domisili_ceknik()" class="form-control" id="domisili_nik" name="domisili_nik" placeholder="Input NIK Pemohon .." required>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="domisili_pekerjaan" name="domisili_pekerjaan" placeholder="Input Pekerjaan Pemohon .." required>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="domisili_alamat">Alamat</label>
                      <input type="text" class="form-control" id="domisili_alamat" name="domisili_alamat" placeholder="Input Alamat Pemohon .." required>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
    ...
    <div class="modal fade" id="arsip" tabindex="-3" aria-labelledby="exampleModalLabel" a data-backdrop="static" data-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url() . 'be/simpan_be/arsip_domisili' ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
