<script>
    ...
    function pkerja() {
        ...
        $('#pkerja_tgllahir').val('');
        $('#pkerja_agama').val('');
        $('#pkerja_pekerjaan').val('');
        $('#pkerja_alamat').val('');
        $('#pkerja_perusahaan').val('');
        $('#pkerja_nohp').val('');
        $('#pkerja_filegambar').val('');
        $('#r_pkerja').modal('show');
    }
